...
class Server:
    ...
    def __init__(self):
        ...
        try:
            ...
            message = json.dumps({SERVER_ID})
            self.client.publish(TOPIC_ALERTS, message)
...
stm = Machine(name='server', transitions=[init, scooter_message, fake_emergency, real_emergency, back_to_listening], obj=server)
server.stm = stm
